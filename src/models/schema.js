export const schema = {
    ...
    Event: {
      ...
      attributes: [
        ...
        },
        {
          ...
          properties: {
            name: "byCreator",
            fields: ["creatorID", "beginningTime"],
          },
        },
      ],
    },
  ...
  enums: {
    NotifType: {
      name: "NotifType",
      values: ["newFollower", "eventInvitation", "friendPlaying"],
    },
    EventPrivacy: {
      name: "EventPrivacy",
