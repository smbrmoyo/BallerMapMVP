...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={{ fontWeight: "bold", color: "#D62976" }}>Click</Text>
    </View>
  );
}
